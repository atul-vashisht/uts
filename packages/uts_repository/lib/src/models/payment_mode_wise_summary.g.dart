...
part of 'payment_mode_wise_summary.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PaymentModeWiseSummary _$PaymentModeWiseSummaryFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'PaymentModeWiseSummary',
      json,
      ($checkedConvert) {
        final val = PaymentModeWiseSummary(
          paymentMode: $checkedConvert('PAYMENT_MODE', (v) => v as String?),
...
Map<String, dynamic> _$PaymentModeWiseSummaryToJson(
        PaymentModeWiseSummary instance) =>
    <String, dynamic>{
